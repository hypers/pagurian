    ...
    (function($) {
        ...
        $.extend($.validator, {
            ...
            defaults: {
                ...
                onfocusin: function(element, event) {
                    ...
                    if (label.length) {
                        ...
                        // create label
                        if ($("." + this.settings.errorClass + "[for=" + this.idOrName(element) + "]").length) {
                            label = $("." + this.settings.errorClass + "[for=" + this.idOrName(element) + "]");
                            label.attr({
            ...
            messages: {
                ...
                rangelength: $.validator.format("长度必须为{0}到{1}位之间"),
                range: $.validator.format("长度必须为{0}到{1}位之间"),
